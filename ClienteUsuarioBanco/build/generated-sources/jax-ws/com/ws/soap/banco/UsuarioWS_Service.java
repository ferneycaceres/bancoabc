 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://banco.soap.ws.com/", wsdlLocation = "http://localhost:8080/UsuarioWS/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://banco.soap.ws.com/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/UsuarioWS/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://banco.soap.ws.com/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://banco.soap.ws.com/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
