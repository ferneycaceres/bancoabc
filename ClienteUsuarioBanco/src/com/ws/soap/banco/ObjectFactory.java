 ...
 * generated in the com.ws.soap.banco package. 
...
public class ObjectFactory {
    ...
    private final static QName _ValidarUsuario_QNAME = new QName("http://banco.soap.ws.com/", "validarUsuario");
    private final static QName _ValidarUsuarioResponse_QNAME = new QName("http://banco.soap.ws.com/", "validarUsuarioResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.soap.banco
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://banco.soap.ws.com/", name = "validarUsuario")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://banco.soap.ws.com/", name = "validarUsuarioResponse")
